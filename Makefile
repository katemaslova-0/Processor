...
OTHER_FLAGS=-Icommands/
TRANSLATOR_SRC=$(wildcard translator/*.cpp)
PROC_SRC=$(wildcard processor/*.cpp)
...
proc: $(PROC_SRC) $(STACK_SRC)
	$(COMP) $(CFLAGS) $(OTHER_FLAGS) -Istack/ $(PROC_SRC) $(STACK_SRC) -o $(TARGET_PROC)

translator:
	$(COMP) $(CFLAGS) $(OTHER_FLAGS) $(TRANSLATOR_SRC) -o $(TARGET_TRANSLATOR)

.PHONY: proc translator